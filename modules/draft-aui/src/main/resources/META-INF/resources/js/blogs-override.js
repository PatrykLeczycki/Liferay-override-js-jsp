            ...
            var Blogs = A.Component.create(
                    {
                        ...
                        prototype: {
                            ...
                            setDescription: function(text) {
                                ...
                                var descriptionLabelNode = instance.one('[for="' + instance.ns('description') + '"]');
                            ...
                            _initDraftSaveInterval: function() {
                                ...
                                console.log('_initDraftSaveInterval');
                            ...
                            _onChangeURLOptions: function() {
                                ...
                                var urlTitleInput = instance.one('#urlTitle');
                                var urlTitleInputLabel = instance.one('[for="' + instance.ns('urlTitle') + '"]');
                            ...
                            _saveEntry: function(draft, ajax) {
                                ...
                                console.log('_oldContent = ' + instance._oldContent);
                                console.log('_oldSubtitle = ' + instance._oldSubtitle);
                                console.log('_oldTitle = ' + instance._oldTitle);
                                ...
                                if (draft && ajax) {
                                    ...
                                    if (hasData && hasChanged) {
                                        ...
                                        var data = instance.ns(
                                                {
                                                    ...
                                                    'entryId': instance.one('#entryId').val(), // jest
                                                    'referringPortletResource': instance.one('#referringPortletResource').val(), // jest
                                                    'subtitle': subtitle,
                                                    'title': title,
                                                    'urlTitle': urlTitle,
                                                    'workflowAction': constants.ACTION_SAVE_DRAFT   // jest
                                        ...
                                        console.log('url: ', instance.get('editEntryURL'));
